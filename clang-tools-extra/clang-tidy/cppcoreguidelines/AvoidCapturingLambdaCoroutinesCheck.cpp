...
void AvoidCapturingLambdaCoroutinesCheck::registerMatchers(MatchFinder *Finder) {
  Finder->addMatcher(lambdaExpr().bind("lambda"), this);
}

void AvoidCapturingLambdaCoroutinesCheck::check(const MatchFinder::MatchResult &Result) {
